...
export default {
    data() {
        return{
            alarmList: [{date: "09:00", content: "히샨님이 라이브를 시작하였습니다."},{date: "1일전", content: "히샨님이 라이브를 시작하였습니다."},{date: "2일전", content: "히샨님이 라이브를 시작하였습니다."},{date: "3일전", content: "히샨님이 라이브를 시작하였습니다."},{date: "4일전", content: "히샨님이 라이브를 시작하였습니다."},{date: "5일전", content: "히샨님이 라이브를 시작하였습니다."},{date: "6일전", content: "히샨님이 라이브를 시작하였습니다."},{date: "7일전", content: "히샨님이 라이브를 시작하였습니다."}, {date: "2020.05.14", content: "히샨님을 구독했습니다."}],
        }
    }
}
</script>
